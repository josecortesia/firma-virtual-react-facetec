export var Config = (function () {
    ...
    function retrieveConfigurationWizardCustomization(FaceTecSDK) {
        ...
        var borderColor = "#004f9f";
        var ovalColor = "#004f9f";
        var dualSpinnerColor = "#004f9f";
        var textColor = "#004f9f";
        var buttonAndFeedbackBarColor =  "#004f9f";
        var buttonAndFeedbackBarTextColor = "#ffffff";
        var buttonColorHighlight = "#00adea";
        var buttonColorDisabled = "#e8e8e8";
        ...
        var yourAppLogoImage = sdkImageDirectory + "firma_virtual_logo.png";
